...
import imgAventus from "@/assets/fragrances/image_w896_h1200_frag-01-aventus.png";
import imgOudWood from "@/assets/fragrances/image_w896_h1200_frag-02-oud-wood.png";
import imgBaccarat from "@/assets/fragrances/image_w896_h1200_frag-03-baccarat-rouge.png";
import imgTobaccoVanille from "@/assets/fragrances/image_w896_h1200_frag-04-tobacco-vanille.png";
import imgBlackOrchid from "@/assets/fragrances/image_w896_h1200_frag-05-black-orchid.png";
...
import imgElysium from "@/assets/fragrances/image_w896_h1200_frag-15-elysium.png";

// New real product photos (cropped to match existing style)
import imgWoodSageSeaSalt from "@/assets/fragrances/image_w896_h1200_frag-12-wood-sage-sea-salt.png";
import imgBeachWalk from "@/assets/fragrances/image_w896_h1200_frag-13-beach-walk.png";
import imgLoveDontBeShy from "@/assets/fragrances/image_w896_h1200_frag-14-love-dont-be-shy.png";
import imgLayton from "@/assets/fragrances/image_w896_h1200_frag-15-layton.png";
import imgErbaPura from "@/assets/fragrances/image_w896_h1200_frag-16-erba-pura.png";
import imgByTheFireplace from "@/assets/fragrances/image_w896_h1200_frag-18-by-the-fireplace.png";
import imgOneMillion from "@/assets/fragrances/image_w896_h1200_frag-19-1-million.png";
import imgCocoMademoiselle from "@/assets/fragrances/image_w896_h1200_frag-22-coco-mademoiselle.png";
import imgColoniaAssoluta from "@/assets/fragrances/image_w896_h1200_frag-25-colonia-assoluta.png";
import imgBleuDeChanelEDP from "@/assets/fragrances/image_w896_h1200_frag-26-bleu-de-chanel-edp.png";
import imgAcquaDiParma from "@/assets/fragrances/image_w896_h1200_frag-17-acqua-di-parma.png";
import imgAngelsShare from "@/assets/fragrances/image_w896_h1200_frag-20-angels-share.png";
import imgGucciFlora from "@/assets/fragrances/image_w896_h1200_frag-21-flora.png";
import imgArmaniSi from "@/assets/fragrances/image_w896_h1200_frag-23-si.png";
import imgTheOne from "@/assets/fragrances/image_w896_h1200_frag-24-the-one.png";
import imgLightBlueEDP from "@/assets/fragrances/image_w896_h1200_frag-27-light-blue-edp.png";
import imgAcquaDiGioProfumo from "@/assets/fragrances/image_w896_h1200_frag-28-acqua-di-gio-profumo.png";
import imgDiorHommeIntense from "@/assets/fragrances/image_w896_h1200_frag-29-dior-homme-intense.png";

// Newly added fragrances (styled to match site)
import imgBlackOpium from "@/assets/fragrances/image_w896_h1200_frag-30-black-opium.png";
import imgLaVieEstBelle from "@/assets/fragrances/image_w896_h1200_frag-31-la-vie-est-belle.png";
import imgHerod from "@/assets/fragrances/image_w896_h1200_frag-32-herod.png";
import imgGypsyWater from "@/assets/fragrances/image_w896_h1200_frag-33-gypsy-water.png";
import imgReplicaFlowerMarket from "@/assets/fragrances/image_w896_h1200_frag-34-replica-flower-market.png";
import imgReflectionMan from "@/assets/fragrances/image_w896_h1200_frag-35-reflection-man.png";
import imgReflectionWoman from "@/assets/fragrances/image_w896_h1200_frag-36-reflection-woman.png";
import imgIrishLeather from "@/assets/fragrances/image_w896_h1200_frag-37-irish-leather.png";
import imgNotAPerfume from "@/assets/fragrances/image_w896_h1200_frag-38-not-a-perfume.png";
import imgBaccaratRouge540Extrait from "@/assets/fragrances/image_w896_h1200_frag-39-baccarat-rouge-540-extrait.png";
...
import imgOudForGreatness from "@/assets/fragrances/image_w896_h1200_frag-42-oud-for-greatness.png";

// Kit images (collages)
import kitIconeUomo from "@/assets/kits/kit-icone-uomo.png";
import kitTabaccoVaniglia from "@/assets/kits/kit-tabacco-vaniglia.png";
import kitViralLuxury from "@/assets/kits/kit-viral-luxury.png";
import kitFlorealeElegante from "@/assets/kits/kit-floreale-elegante.png";
import kitFrescoEstivo from "@/assets/kits/kit-fresco-estivo.png";
import kitEquilibrioQuotidiano from "@/assets/kits/kit-equilibrio-quotidiano.png";
...
const FRAGRANCES = [
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 11 }, { ml: 5, price: 33 }, { ml: 10, price: 65 }, { ml: 100, price: 350, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 17 }, { ml: 5, price: 42 }, { ml: 10, price: 85 }, { ml: 50, price: 289, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 11 }, { ml: 5, price: 26 }, { ml: 10, price: 49 }, { ml: 100, price: 375, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 9 }, { ml: 5, price: 18 }, { ml: 10, price: 33 }, { ml: 50, price: 140, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 5 }, { ml: 5, price: 11 }, { ml: 10, price: 22 }, { ml: 50, price: 80, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 6 }, { ml: 5, price: 15 }, { ml: 10, price: 30 }, { ml: 100, price: 152, full: true }],
...
const MORE_FRAGRANCES: Fragrance[] = [
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 6 }, { ml: 5, price: 15 }, { ml: 10, price: 35 }, { ml: 100, price: 195, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 8 }, { ml: 5, price: 20 }, { ml: 10, price: 40 }, { ml: 100, price: 230, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml:  2, price:  6 }, { ml:  5, price:  14 }, { ml:  10, price:  28 }, { ml:  100, price:  140, full:  true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml:  2, price:  6 }, { ml:  5, price:  13 }, { ml:  10, price:  25 }, { ml:  100, price:  140, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  8 }, { ml:  5, price:  20 }, { ml:  10, price:  40 }, { ml:  125, price:  310, full:  true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml:  2, price:  12 }, { ml:  5, price:  29 }, { ml:  10, price:  59 }, { ml:  50, price:  179, full:  true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml:  2, price:  6 }, { ml:  5, price:  14 }, { ml:  10, price:  28 }, { ml:  100, price:  160, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  4 }, { ml:  5, price:  9 }, { ml:  10, price:  18 }, { ml:  100, price:  92, full:  true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml:  2, price:  16 }, { ml:  5, price:  38 }, { ml:  10, price:  75 }, { ml:  50, price:  250, full:  true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml:  2, price:  6 }, { ml:  5, price:  13 }, { ml:  10, price:  27 }, { ml:  100, price:  120, full:  true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml:  2, price:  9 }, { ml:  5, price:  22 }, { ml:  10, price:  44 }, { ml:  100, price:  220, full:  true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml:  2, price:  5 }, { ml:  5, price:  12 }, { ml:  10, price:  24 }, { ml:  100, price:  120, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  8 }, { ml:  5, price:  14 }, { ml:  10, price:  28 }, { ml:  100, price:  165, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  11 }, { ml:  5, price:  25 }, { ml:  10, price:  50 }, { ml:  50, price:  185, full:  true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml:  2, price:  7 }, { ml:  5, price:  14 }, { ml:  10, price:  30 }, { ml:  100, price:  185, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  8 }, { ml:  5, price:  18 }, { ml:  10, price:  39 }, { ml:  75, price:  195, full:  true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml:  2, price:  7 }, { ml:  5, price:  14 }, { ml:  10, price:  29 }, { ml:  100, price:  145, full:  true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml: 2, price: 8 }, { ml: 5, price: 18 }, { ml: 10, price: 35 }, { ml: 90, price: 185, full: true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml: 2, price: 6 }, { ml: 5, price: 10 }, { ml: 10, price: 23 }, { ml: 100, price: 100, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 11 }, { ml: 5, price: 25 }, { ml: 10, price: 51 }, { ml: 75, price: 250, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 8 }, { ml: 5, price: 23 }, { ml: 10, price: 44 }, { ml: 100, price: 265, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 7 }, { ml: 5, price: 14 }, { ml: 10, price: 29 }, { ml: 100, price: 135, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 12 }, { ml: 5, price: 29 }, { ml: 10, price: 58 }, { ml: 100, price: 385, full: true }],
  ...
  },
  {
    ...
    gender: "Women",
    genderIt: "Donna",
    sizes: [{ ml: 2, price: 11 }, { ml: 5, price: 29 }, { ml: 10, price: 58 }, { ml: 100, price: 405, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 12 }, { ml: 5, price: 28 }, { ml: 10, price: 59 }, { ml: 75, price: 280, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 5 }, { ml: 5, price: 14 }, { ml: 10, price: 29 }, { ml: 100, price: 125, full: true }],
  ...
  },
  {
    ...
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 17 }, { ml: 5, price: 40 }, { ml: 10, price: 82 }, { ml: 70, price: 399, full: true }],
  ...
  },
  {
    ...
    gender: "Men",
    genderIt: "Uomo",
    sizes: [{ ml: 2, price: 6 }, { ml: 5, price: 14 }, { ml: 10, price: 30 }, { ml: 100, price: 150, full: true }],
  ...
  },
  {
    ...
    notes: { top: ["Oud", "Nutmeg", "Saffron"], heart: ["Patchouli", "Vetiver"], base: ["Musk", "Ambergris"] },
    notesIt: { top: ["Oud", "Noce Moscata", "Zafferano"], heart: ["Patchouli", "Vetiver"], base: ["Muschio", "Ambra Grigia"] },
    family: "Woody Oriental",
    familyIt: "Legnoso Orientale",
    gender: "Unisex",
    genderIt: "Unisex",
    sizes: [{ ml: 2, price: 20 }, { ml: 5, price: 50 }, { ml: 10, price: 100 }, { ml: 90, price: 445, full: true }],
    description: "A monument in a bottle. Oud for Greatness is a raw, powerful, and unapologetic celebration of oud in its most primitive form. It layers the darkest, smokiest agarwood with nutmeg, saffron, and patchouli for an animalic, commanding presence. Not for the timid — this is oud for those who conquer.",
    descriptionIt: "Un monumento in un flacone. Oud for Greatness è una celebrazione cruda, potente e senza scuse dell'oud nella sua forma più primitiva. Stratifica il legno d'aloe più scuro e affumicato con noce moscata, zafferano e patchouli per una presenza animalica e imponente.",
    badge: "Niche",
    emoji: "🏆",
    image: imgOudForGreatness,
    rating: 4.9,
    reviews: 760,
  },
];
        ...
        <div id="results" style={{ maxWidth: isWide ? 1440 : 1200, margin: "0 auto", padding: isMobile ? "22px 10px" : isTablet ? "36px 22px" : "46px 34px" }}>
          {activeTab === "shop" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: `repeat(${cols},minmax(0,1fr))`, columnGap: isMobile ? 10 : isTablet ? 16 : 20, rowGap: isMobile ? 10 : isTablet ? 16 : 20, alignItems: "start" }}>
                {filtered.map((f) => (
